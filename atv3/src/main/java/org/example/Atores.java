...
@Component
public class Atores implements Indicavel{
    private String nome;
    ...
    @Autowired
    public Atores(String nome, String nacionalidade, Short numeroDeIndicacoes, Boolean elegivel) {
        this.nome = nome;
    ...
    public String toString() {
        return "Nome do ator: " + this.nome + "." + "  " + "Indicações: " + this.numeroDeIndicacoes + "." + "  ";
    }
}
