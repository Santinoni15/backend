...
@Component
public class Filmes implements Indicavel{
    private String nome;
    ...
    @Autowired
    public Filmes(String nome, String genero, Short numeroDeIndicacoes, Boolean elegivel) {
        this.nome = nome;
        this.genero = genero;
    ...
    public String toString() {
        return "Nome do filme: " + this.nome + "." + "  " + "Indicações: " + this.numeroDeIndicacoes + "." + "  ";
    }
}
